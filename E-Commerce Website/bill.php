...
<head>
<meta charset="UTF-8">
    <meta name="author" content="Sandhya Shankar(2021     )">
      ...
      <form method="post">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" id="fname" name="firstname" placeholder="Sandhya Shankar">
            <label for="email"><i class="fa fa-envelope"></i> Email</label>
            <input type="text" id="email" name="email" placeholder="sandhya@example.com">
            ...
            <div class="row">
              ...
              <div class="col-50">
                ...
                <input type="text" id="zip" name="zip" placeholder="600069">
              </div>
            </div>
          </div>
          ...
          <img src="images/uslogo.jpeg" width="200" height="150" alt="uslogo1"><br>
            ...
            <input type="text" id="cname" name="cardname" placeholder="Sandhya Shankar">
