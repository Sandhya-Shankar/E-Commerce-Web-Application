...
<body>
    ...
    <main>
        <div style="background-image: url('../images/bgdindex1.jpg');">
        <br><br>
        <h1 class="appul0">Appliances Service and Repair in Chennai</h1>
        <br><br><br>
        <ul class="appul">
            <li><h3>Urban Service provides several services to repair appliances<br>such as Refrigerators, Air-Conditioners and Washing Machines</h3>
            </li>
            <br><br>
            ...
            <br><br> 
            <li><h3>90 Day Repair Guarantee</h3></li>  
            <br><br>
            <li><h3>Protection Against Damage upto INR 5,000</h3></li>  
            <br><br><br><br>
            <img src="../images/wmicon.jpg" height="60" width="60" alt="wmi">
            <img src="../images/acicon.jpg" height="60" width="60" alt="aci">
            <img src="../images/fridgeicon.jpg" height="60" width="60" alt="fri">
            <br><br>
        </ul>
        </div>
        <form method="post">
    ...
    if($result->num_rows>0){
        ...
        echo "<br><br>";
        echo "<img src='../images/$img' height='200' width='200'>";
        echo "</div>";
        }    
    }   
    echo "<br><br><input class='tocartapp'name='tocartapp' type='submit' value='Move to Cart'><br><br>";
echo "</form>";
?>
<?php
if(isset($_POST['cart'])){
